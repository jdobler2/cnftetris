//SmallIntArrayTrie2.h

#ifndef SMALL_INT_ARRAY_TRIE2_H_
#define SMALL_INT_ARRAY_TRIE2_H_

#include "IntArrayTrie.h"

class SmallIntArrayTrie2 : public IntArrayTrie {
  protected:
  ...
  public:
   SmallIntArrayTrie2();
   SmallIntArrayTrie2(int newLayer);
   ~SmallIntArrayTrie2();
